...
describe("Accessories Module", () => {
  ...
  test("Should Accessories screen display correctly", async () => {
    ...
    const accessoriesbtn = driver.findElement(
      By.xpath(`/html/body/div/div/div[1]/div/ul/li[5]/a/p`)
    );
    await accessoriesbtn.click();

    //find materials of screen
    const importButton = driver.findElement(
      By.xpath(
        `/html/body/div/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/button`
      )
    );
    const title = driver.findElement(
      By.xpath(
        `/html/body/div/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/h4`
      )
    );
  ...
  test("Should import button work correctly", async () => {
    ...
    const importModal = driver.findElement(
  ...
  test("Should accessories import without listed", async () => {
    ...
    const importButton = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[3]/button[2]`)
    );
    await importButton.click();
    await driver.sleep(500);
    const alert = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[2]/div/div/div`)
    );
    expect(alert.isDisplayed);
    const closeAlert = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[2]/div/div/div/button`)
    );
  ...
  test("Should add type button work correctly", async () => {
    //find materials of screen
    await driver.sleep(1000);
    const addTypeBtn = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[3]/div[2]/div[2]/div[2]/button`
      )
    );
    await addTypeBtn.click();
    await driver.sleep(200);
    const addTypeModal = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div`)
    );
  ...
  test("Should type can add duplicated", async () => {
    const typeInput = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[2]/form/div/input`)
    );
    await typeInput.sendKeys("Nắp ca bô");
    const addBtn = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[3]/button[1]`)
    );
    await addBtn.click();
    await driver.sleep(500);
    const duplicatedAlert = await driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[3]`)
    );
    expect(duplicatedAlert.isDisplayed);
    const closeAlert = await driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[3]/button`)
    );
    await closeAlert.click();
  });

  test("Should type add correctly", async () => {
    const typeList = await driver.findElements(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[3]/div[2]/div[2]/div[1]/div/select/option`
      )
    );
    ...
    await addBtn.click();
    await driver.sleep(500);
    const updatedTypeList = await driver.findElements(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[3]/div[2]/div[2]/div[1]/div/select/option`
      )
    );
  ...
  test("Should add provider button work correctly", async () => {
    //find materials of screen
    await driver.sleep(200);
    const addProviderBtn = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[4]/div/div/div[2]/button`
      )
    );
    await addProviderBtn.click();
    await driver.sleep(200);
    const addProviderModal = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div`)
    );
  ...
  test("Should provider can add duplicated", async () => {
    const nameInput = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[2]/form/div[1]/input`)
    );
    const phoneNumberInput = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[2]/form/div[2]/input`)
    );
    const addressInput = driver.findElement(
      By.xpath(`/html/body/div[3]/div/div[1]/div/div/div[2]/form/div[3]/input`)
    );
  ...
  test("Should provider add correctly", async () => {
    const providerList = await driver.findElements(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[4]/div/div/div[1]/div/select/option`
      )
    );
    ...
    await addBtn.click();
    await driver.sleep(500);
    const updatedProviderList = await driver.findElements(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[4]/div/div/div[1]/div/select/option`
      )
    );
  ...
  test("Should accessory being listed without selecting provider field", async () => {
    const listedButton = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[2]/button`)
    );

    const accessoryField = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[1]/div/div/input`
      )
    );
    const valueInput = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[2]/div[1]/div/input`
      )
    );
    const quantityInput = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[2]/div[2]/div/input`
      )
    );
    const expiredDateField = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[2]/div[4]/div/input`
      )
    );
    const unitField = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[3]/div[1]/div/input`
      )
    );
    const descriptionField = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[5]/div/textarea[1]`
      )
    );
    ...
    //find materials of screen
    const warning = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[2]/div[1]`)
    );
    expect(warning.isDisplayed());
    const hideButton = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[2]/div[1]/button`)
    );
    await driver.sleep(200);
  ...
  test("Should accessory being listed without selecting accessoryType field", async () => {
    ...
    const providerField = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[4]/div/div/div[1]/div/select`
      )
    );
  ...
  test("Should cash being calculated correctly", async () => {
    ...
    await quantityInput.clear();
    await quantityInput.sendKeys("5");
    const cashInput = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[2]/div[3]/div/input`
      )
    );
  ...
  test("Should accessories being imported correctly", async () => {
    const cancelButton = driver.findElement(
    ...
    const rows = await driver.findElements(
      By.xpath(
        "/html/body/div/div/div[2]/div[1]/div/div/div/div/div/div[2]/table/tbody/tr"
      )
    );
    ...
    const accessoryTypeField = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/form/div[3]/div[2]/div[2]/div[1]/div/select`
      )
    );
    const providerField = driver.findElement(
      By.xpath(
    ...
    const importToStorage = driver.findElement(
      By.xpath(`/html/body/div[2]/div/div[1]/div/div/div[3]/button[2]`)
    );
    await importToStorage.click();

    await driver.sleep(1000);
    const updatedRows = await driver.findElements(
      By.xpath(
        "/html/body/div/div/div[2]/div[1]/div/div/div/div/div/div[2]/table/tbody/tr"
      )
    );
  ...
  test("Should accessories being listed correctly", async () => {
    ...
    const listedAccessory = driver.findElement(
      By.xpath(
        `/html/body/div[2]/div/div[1]/div/div/div[2]/div/div/table/tbody/tr`
      )
    );
