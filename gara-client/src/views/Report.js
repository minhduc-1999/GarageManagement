...
function Report() {
  ...
  useEffect(() => {
    ...
    axios.get(process.env.REACT_APP_BASE_URL + "api/report/accessory-receipt/", {
      params: {
        option: acessoryReportType,
        year: selectAYear,
        ...(acessoryReportType === "monthly" ? { month: selectAMonth } : {})
      },
      headers: {
  ...
  async function fetchAccessoryIssuesReportData() {
    axios.get(process.env.REACT_APP_BASE_URL + "api/report/accessory-issue/", {
      params: {
        option: acessoryReportType,
        year: selectAYear,
        ...(acessoryReportType === "monthly" ? { month: selectAMonth } : {})
  ...
  const showReport = () => {
    if (((!selectMonth || !selectYear) && reportType === "monthly")
      ...
      axios.get(process.env.REACT_APP_BASE_URL + "api/report/" + reportOption, {
        ...
        setDataChart(getRes(res.data.sort((item1, item2)=>(Number(item1.label)-(Number(item2.label))))));
        console.log(res);
      }).catch(error => console.log(error))
    }
  }
            ...
            <Col md="12">
              ...
              <Col className="text-left" sm="6">
                        ...
                        <Row>
                          ...
                          <Col sm="1.5" hidden={acessoryReportType === "annual"}>
                            <h4 style={{marginTop: 5}}>
                              Năm
                            </h4>
                          </Col> 
